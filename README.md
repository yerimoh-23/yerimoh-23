...
I am a quantitative analyst focused on operational analytics, statistical modeling, and data-driven decision systems.

My work centers on transforming unstable or ambiguous processes into measurable structures — building models that connect variability to actionable decisions.

### What I Do 🔎
- Workforce demand modeling & operational forecasting
- Statistical analysis & regression
- Simulation modeling (agent-based & structural dynamics)
- Data cleaning, structuring, and exploratory analysis
- Translating quantitative results into operational decisions
...
![SQL](https://img.shields.io/badge/-SQL-f29111?&logoColor=00758f)
